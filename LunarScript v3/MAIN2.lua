...
-- =================================================================
-- MULTI TELEPORT FRAME (DIMODIFIKASI DENGAN KECEPATAN)
-- =================================================================
...
MultiTeleportFrame.CanvasSize = UDim2.new(0,0,0,450) -- Diperbesar untuk kecepatan
...
CoordInputSection.Position = UDim2.new(0,10,0,120)
...
ButtonsSection.Position = UDim2.new(0,10,0,250)
...
CoordinatesListSection.Position = UDim2.new(0,10,0,410)
...
AntiAFKDescription.Text = "Mencegah kick saat AFK dengan menggerakkan mouse"
...
AutoJumpDescription.Text = "Lompat otomatis di interval tertentu untuk mencegah kick AFK"
...
JumpIntervalLabel.Text = "Interval (menit):"
...
-- =================================================================
-- MULTI TELEPORT FUNCTIONS (DIMODIFIKASI DENGAN KECEPATAN)
-- =================================================================
...
local function TeleportToCoordinates()
    ...
    for i = #MultiTeleport.Coordinates, 1, -1 do
        ...
        wait(1 / speed) -- Menggunakan kecepatan untuk menentukan delay
    end
...
-- =================================================================
-- CONNECT EVENT HANDLERS (DITAMBAH AFK)
-- =================================================================
...
print("=====================================")
print("LunarScript v3.0 - Loaded Successfully!")
print("Created by h4000_audio8 & DarkLua_script")
print("=====================================")
